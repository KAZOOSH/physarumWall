...
const vec3 tealSunset[7] = vec3[7](
        vec3(0.0),
        vec3(0.0),
        vec3(0.05f, 0.2f, 0.3f),
        vec3(0.2f, 0.4f, 0.5f),
        vec3(0.6f, 0.3f, 0.4f),
        vec3(0.8f, 0.4f, 0.3f),
        vec3(1.0f, 0.5f, 0.2f)
...
const vec3 forestNight[7] = vec3[7](
        vec3(0.0),
        vec3(0.0),
        vec3(0.0f, 0.1f, 0.0f),
        vec3(0.0f, 0.3f, 0.2f),
...
const vec3 purpleFire[7] = vec3[7](
        vec3(0.0),
        vec3(0.0),
        vec3(0.1f, 0.3f, 0.6f),
        vec3(0.3f, 0.2f, 0.5f),
...
const vec3 arctic[7] = vec3[7](
        ...
        vec3(0.1f, 0.6f, 0.8f),
        vec3(0.4f, 0.8f, 1.0f),
        vec3(0.85f, 0.96f, 1.0f)
    );

const vec3 cyan[7] = vec3[7](
        vec3(0.0),
        vec3(0.0),
        vec3(0.0f, 0.3f, 0.4f),
        vec3(0.0f, 0.5f, 0.6f),
...
const vec3 neonInferno[6] = vec3[6](
        vec3(0.0),
        vec3(0.2f, 0.0f, 0.3f),
        vec3(0.6f, 0.0f, 0.6f),
        vec3(0.8f, 0.1f, 0.2f),
...
const vec3 solarDrift[7] = vec3[7](
        vec3(0.0),
        vec3(0.0),
        vec3(0.3f, 0.1f, 0.0f),
        vec3(0.6f, 0.2f, 0.0f),
...
void main() {
    ...
    // test using objects
    float objColor = imageLoad(objectRead, ivec2(gl_GlobalInvocationID.xy)).x;
    //imageStore(trailWrite, ivec2(gl_GlobalInvocationID.xy), vec4(val * objColor, prevColor.y * 1.0, 0, 0));
