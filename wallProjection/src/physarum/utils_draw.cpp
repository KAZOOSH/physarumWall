...
void Physarum::drawTextBox(const std::string &stringToShow, ofTrueTypeFont *pFont, float col, float alpha)
{
    ofPushMatrix();
    ofSetColor(col, 150);
...
std::string Physarum::roundedString(float value)
{
...
void Physarum::drawCustomCircle(ofVec2f pos, float R, float r)
{
    int mCircle = 14;
...
void Physarum::drawPad(float col, float alpha)
{
    ofPushMatrix();
